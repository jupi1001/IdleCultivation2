...
- Sect phase 2
    - Phase2:
     **To get items from the demonic sect you have to battle them. So if you are a core displicine in your rightous sect you can battle a demonic sect and then get the loot from a loot table up to the core displicne level.**
