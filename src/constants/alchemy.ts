...
export const ALCHEMY_RECIPES: AlchemyRecipeI[] = [
  {
    ...
    output: {
      ...
      price: 0,
      quantity: 1,
      picture: `${ALCHEMY_ASSETS}/basic-qi-pill.png`,
      value: 1,
      effect: "attack",
    },
    outputAmount: 1,
  },
  {
    ...
    output: {
      ...
      price: 0,
      quantity: 1,
      picture: `${ALCHEMY_ASSETS}/spirit-qi-pill.png`,
      value: 3,
      effect: "attack",
    },
    outputAmount: 1,
  },
  {
    ...
    output: {
      ...
      price: 0,
      quantity: 1,
      picture: `${ALCHEMY_ASSETS}/refined-qi-pill.png`,
      value: 5,
      effect: "attack",
    },
    outputAmount: 1,
  },
  {
    ...
    output: {
      ...
      price: 0,
      quantity: 1,
      picture: `${ALCHEMY_ASSETS}/condensation-pill.png`,
      value: 8,
      effect: "attack",
    },
    outputAmount: 1,
  },
  {
    ...
    output: {
      ...
      price: 0,
      quantity: 1,
      picture: `${ALCHEMY_ASSETS}/foundation-pill.png`,
      value: 12,
      effect: "attack",
    },
    outputAmount: 1,
  },
  {
    ...
    output: {
      ...
      price: 0,
      quantity: 1,
      picture: `${ALCHEMY_ASSETS}/herb-vitality-pill.png`,
      value: 2,
      effect: "vitality",
    },
    outputAmount: 1,
  ...
  // Mid-tier Qi pills (new herbs)
  {
    ...
    output: {
      ...
      price: 0,
      quantity: 1,
      picture: `${ALCHEMY_ASSETS}/lunar-qi-pill.png`,
      value: 15,
      effect: "qi",
    },
    outputAmount: 1,
  },
  {
    ...
    output: {
      ...
      price: 0,
      quantity: 1,
      picture: `${ALCHEMY_ASSETS}/stellar-condensation-pill.png`,
      value: 18,
      effect: "qi",
    },
    outputAmount: 1,
  },
  {
    ...
    output: {
      ...
      price: 0,
      quantity: 1,
      picture: `${ALCHEMY_ASSETS}/void-refined-pill.png`,
      value: 22,
      effect: "qi",
    },
    outputAmount: 1,
  },
  {
    ...
    output: {
      ...
      price: 0,
      quantity: 1,
      picture: `${ALCHEMY_ASSETS}/celestial-qi-pill.png`,
      value: 26,
      effect: "qi",
    },
    outputAmount: 1,
  },
  {
    ...
    output: {
      ...
      price: 0,
      quantity: 1,
      picture: `${ALCHEMY_ASSETS}/transcendent-qi-pill.png`,
      value: 32,
      effect: "qi",
    },
    outputAmount: 1,
  ...
  // Mid- and high-tier Vitality pills
  {
    ...
    output: {
      ...
      price: 0,
      quantity: 1,
      picture: `${ALCHEMY_ASSETS}/spirit-vitality-pill.png`,
      value: 4,
      effect: "vitality",
    },
    outputAmount: 1,
  },
  {
    ...
    output: {
      ...
      price: 0,
      quantity: 1,
      picture: `${ALCHEMY_ASSETS}/refined-vitality-pill.png`,
      value: 6,
      effect: "vitality",
    },
    outputAmount: 1,
  },
  {
    ...
    output: {
      ...
      price: 0,
      quantity: 1,
      picture: `${ALCHEMY_ASSETS}/primordial-vitality-pill.png`,
      value: 8,
      effect: "vitality",
    },
    outputAmount: 1,
  },
  {
    ...
    output: {
      ...
      price: 0,
      quantity: 1,
      picture: `${ALCHEMY_ASSETS}/transcendent-vitality-pill.png`,
      value: 10,
      effect: "vitality",
    },
    outputAmount: 1,
